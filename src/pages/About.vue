  ...
  <Layout>
    <main>
      <article class="container">
        ...
        <p>
          My name is Forbes Gray, a freelance website developer with over 7
          years experience building websites and web applications for a variety
          of business' and industries, across Edinburgh and further afield.
        </p>
        <p>
          My interest in Web Development started fairly late. I have a
          background in sales spanning 10 years in the telecoms industry. As my
          skills grew I started up my own company supplying telecoms to
          business.
        </p>
        <p>
        ...
        <p>
          ...
          Although creating a presence online I was frustrated by the
          constraints of building using a tool like Google Sites (and I wanted
          rounded corners).
        </p>
        ...
        <p>
          I had never written any HTML or CSS at this stage but felt that it
          couldn't be hard to create the simple site that I was looking for. I
          started teaching myself HTML and CSS and very quickly was able to
          create a website that I was far more satisfied with, but more
          importantly found that I really enjoyed doing it.
        </p>
        <p>
          I continued to learn and optimise my companies site. In order to make
          the site more maintainable and interactive I started to learn a little
          PHP and got a firmer grasp of JavaScript.
        </p>
        <p>
        ...
        <p>
          With the growth of JavaScript and NodeJS, web applications were
          becoming evermore capable and I found my new test. JavaScript became
          my focus.
        </p>
        <p>
          BlackBerry have always had a place in my heart so I used their
          platform to hone my skills. Creating simple Webworks/Cordova
          applications gave me small projects to to discover the capabilities
          and pitfalls of JavaScript.
        </p>
        <p>
          At the same time I was discovering more about running JavaScript on
          the server with NodeJS and interacting with NoSQL Databases such as
          MongoDB and CouchDB. I created a couple of applications using the MEAN
          Stack using Angular for the front-end.
        </p>
        <p>
          As these new JavaScript frameworks developed I was introduced to a
          number of different approaches to complete a development project, but
        ...
        <p>
          ...
          embracing new tools a technologies to improve a websites performance
          and the users experience.
        </p>
        <p>
          Some of my website design and
          <g-link to="/">web application development</g-link> work can be found

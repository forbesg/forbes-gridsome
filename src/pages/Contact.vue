  ...
  <Layout>
    <div class="container">
      ...
      <div class="flex-container">
        <div class="left">
          <g-image src="/images/me.jpg" alt="Forbes Gray"></g-image>
          <h4>Contact Information</h4>
          <address class="address">
            <span>Forbes Gray</span>
            <span>Edinburgh</span>
            <span>EH6 4LB</span>
          </address>
          <ul class="social-links">
            <li>
              <a href="https://www.github.com/forbesg" rel="noopener" target="_blank">
            ...
            <li>
              <a href="https://www.twitter.com/4beez" rel="noopener" target="_blank">
            ...
            <li>
              <a href="https://www.instagram.com/4beeeez" rel="noopener" target="_blank">
          ...
          <div v-if="!formSuccess">
            <form @submit.prevent="handleSubmitForm" ref="contact_form" action="https://getform.io/f/ce537464-4e11-4163-b480-35d3fd2b7305" method="post" enctype="json">
              ...
              <div class="form-group">
                ...
                <input type="text" name="name" id="name" v-model="form.name" placeholder="Your Name - required">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="tel" name="phone_number" id="phone_number" v-model="form.phone_number" placeholder="Your Number">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input :class="{ 'loading': form.loading }" type="submit" class="button" :value="form.loading ? 'Sending...' : 'Send'">
              </div>
            </form>
          </div>
...
export default {
  ...
  methods: {
    handleSubmitForm () {
       ...
       */
      grecaptcha.execute('6LfAtbQZAAAAALIFif4qLLmJc-Khmg4iKxMm6F6G', { action: 'submit' })
        .then(function(token) {
          document.getElementById('captchaResponse').value = token
          return fetch('https://getform.io/f/ce537464-4e11-4163-b480-35d3fd2b7305', {
            method: 'POST',

      ...
      <div class="flex-container">
        <div class="left">
          ...
          <ul class="social-links">
            ...
            <li>
              <a
                href="https://www.twitter.com/4beez"
                rel="noopener"
                target="_blank"
              >
                <svg
            ...
            <li>
              <a
                href="https://www.instagram.com/4beeeez"
                rel="noopener"
                target="_blank"
              >
                <svg
        ...
        <div class="right">
          <div v-if="!formSuccess">
            <form
              ...
              ref="contact_form"
              action="https://getform.io/f/ce537464-4e11-4163-b480-35d3fd2b7305"
              method="post"
              enctype="json"
            >
              <input
              ...
              <div class="form-group">
                ...
                <input
                  ...
                  type="submit"
                  class="button"
                  :value="form.loading ? 'Sending...' : 'Send'"
                />
              </div>
            </form>
          </div>

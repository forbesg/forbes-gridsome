    ...
    <div class="container project">
      ...
      <aside class="">
        <div class="">
          ...
          <ul>
            <li v-for="(tech, index) in $page.project.features" :key="index">{{tech}}</li>
          </ul>
          <a v-if="$page.project.url" :href="$page.project.url" target="_blank" rel="noopener">View Website</a>
          <a v-if="$page.project.repo" :href="$page.project.repo" target="_blank" rel="noopener">View Git Repo</a>
        </div>
      </aside>
    </div>
